      ...
      <main className="mx-auto min-h-screen max-w-7xl px-4 pb-24 pt-28 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-12">
          ...
          <div className="space-y-6 lg:col-span-8">
            {!result && !loading && (
              <div className="flex min-h-[400px] items-center justify-center rounded-2xl border border-dashed border-foreground/10 bg-muted/10">
            ...
            {loading && (
              <div className="flex min-h-[400px] items-center justify-center rounded-2xl border border-foreground/5 bg-muted/10">
